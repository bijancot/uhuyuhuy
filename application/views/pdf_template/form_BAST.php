...
<head>
    ...
    <title>FORM BERITA ACARA SERAH TERIMA</title>
    <style>
        html,
        body {
...
<body>
    <div class="wrapper-page">
        ...
        <table class="border-1 border-collapse w-100 valign-middle mb-min">
            ...
            <tr>
                ...
                <td class="text-regular">
                    <div class="text-regular pl-min pt-min">
                        <div> : FORM 005/PROS-MFP-MLK3-015</div>
                        <div> : 1</div>
                        <div> : 1 Dari 1</div>
                    </div>
                </td>
        ...
        <table class="w-100 mb-min">
            <tr>
                <th class="text-align-center">
                    <strong>
                        <u>BERITA ACARA SERAH TERIMA PERTAMA</u>
                    </strong>
                </th>
            </tr>
            <tr>
        ...
        <table>
            <tr>
                <td class="text-regular" style="float: left">
                    Pada hari ini <?= $date?>, kami yang bertanda tangan dibawah ini :,
                </td>
            </tr>
        </table>
        <br>
        <dd>
            <table>
                ...
                <tr>
                    ...
                    <td class="text-regular" style="float: left">
                        Jalan Raya Bekasi KM. 22 Cakung, Jakarta 13910
                    </td>
                </tr>
            </table>
        </dd>
        ...
        <table>
            <tr>
                <td class="text-regular" style="float: left">
                    Selanjutnya disebut sebagai <strong>Pemberi Tugas</strong>,
                </td>
            </tr>
        </table>
        <dd>
        ...
        <table>
            <tr>
                <td class="text-regular" style="float: left">
                    Selanjutnya disebut sebagai <strong>Penerima Tugas</strong>,
                </td>
            </tr>
        </table>
        <br>
        <table>
            <tr>
                <td class="text-regular" style="float: left">
                    Kedua belah pihak telah setuju dan sepakat untuk melakukan _______________________ untuk ___________________________ sebagai berikut :,
                </td>
            </tr>
        </table>
        <br>
